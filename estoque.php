            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 style="text-align: center;">SISTEMA DE ENTRADAS



                            <a href="FILTROFINALE.php" class="btn btn-danger float-end">VOLTAR</a>
                    ...
                    <div class="card-body" style="background-color: orange;width: 100%;">
                        ...
                        <form action="processarentrada.php" method="POST">
                            <br><br><br>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0" id="quantidadee" name="quantidadee" class="d-inline" style="width: 150px;text-align: center;" required>

                                <label for="custoo">Valor de Custo:</label>
                                <input type="number" step="0.01" id="custoo" name="custoo" class="d-inline" style="width: 150px;text-align: center;" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="fornecedor" name="fornecedor" class="d-inline" style="width: 150px;text-align: center;" required>

                                <label for="factura">Numero de Factura:</label>
                                <input type="text" step="0" id="factura" name="factura" class="d-inline" style="width: 150px;text-align: center;" required>

                                <label for="usuario">:</label>
                                <input type="hidden" id="usuario" name="usuario" class="d-inline" style="width: 150px;text-align: center;" required>
                            ...
                            <div class="mb-3">
                                ...
                                <button type="submit" name="Enviar" class="btn btn-primary">Realizar Entrada</button>
                ...
                <div class="card" style="width: 100%;">
                    <div class="card-header">
                        <h4 style="text-align: center;">Tabela de Saidas
                            <a href="FILTROFINAL.php" class="btn btn-primary float-end">Fazer Relatório</a>
                            <!--mt-5 espaçamencto
                            -->
                        </h4>
                    </div>
                        ...
                        <table class="table table-borded table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">USUARIO EDIÇÃO</th>
                            ...
                            <tbody style="border-color: red;">
                                ...
                                $query = "SELECT produtocodigo , fornecedor , factura , dataEntrada , usuarioEntrada , dataEdicao , usuarioEdicao 
                                        SUM(quantidadee) AS quantidadeTotal, 
                                        SUM(custo ) AS custoTotal , 
                                        FROM entrada 
                                WHERE produtocodigo  LIKE '%d%' 
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?= $entradas['codigoProduto']; ?></td>
                                            <td style="text-align: center;"><?= $entradas['quantidadeTotal']; ?></td>
                                            <td style="text-align: center;"><?= $entradas['custoTotal']; ?></td>
                                            <td style="text-align: center;"><?= $entradas['vendaTotal']; ?></td>
                                            <td style="text-align: center;"><?= $entradas['codigoProduto']; ?></td>
                                            <td style="text-align: center;"><?= $entradas['quantidadeTotal']; ?></td>
                                            <td style="text-align: center;"><?= $entradas['custoTotal']; ?></td>
                                            <td style="text-align: center;"><?= $entradas['vendaTotal']; ?></td>
