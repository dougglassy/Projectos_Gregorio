                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 style="text-align: center;">SISTEMA DE ENTRADAS
                            ...
                            <a href="relatorientradas.php" class="btn btn-danger float-end">VOLTAR</a>
                    ...
                    <div class="card-body" style="background-color: orange;width: 100%;">
                        ...
                        <form action="processarentrada.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="usuarioo"></label>
                                <input type="hidden" id="usuarioo" name="usuarioo" value="ADMIN" class="d-inline" style="width: 150px;text-align: center;" required>
                ...
                <div class="card" style="width: 100%;">
                    <div class="card-header">
                        <h4 style="text-align: center;">Tabela de Saidas
                            <a href="relatorientradas.php" class="btn btn-info float-end">Fazer Relatório</a>
                            <!--mt-5 espaçamencto
                            -->
                        </h4>
                    </div>
                    <div class="card-body">
                        <table class="table table-borded table-striped">
                            ...
                            <tbody style="border-color: red;">
                                ...
                                $query = "SELECT produtocodigo, fornecedor, factura,
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?= $entradas['fornecedor']; ?></td>
