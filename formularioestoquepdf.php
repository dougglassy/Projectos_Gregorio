...
function configurarCabecalhoPDF($pdf)
{
...
function gerarRelatorioPDF($conn, $pdf)
{
    try {
...
// Se a conexão for bem sucedida, continuamos com o relatório PDF
if ($conn) {
    // Criação do PDF
    $pdf = new TCPDF('P', 'mm', 'A4', true, 'UTF-8');
