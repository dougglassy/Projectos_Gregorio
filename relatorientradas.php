                        ...
                        <form action="">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="datainicial" id="datainicial" class="d-inline" style="width: 250px; text-align: center;">
                                    ...
                                    $consulta = "SELECT dataEntrada FROM entrada";
                                    ...
                                    if (mysqli_num_rows($resultado) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($resultado)) {
                                            echo '<option value="' . $row['dataEntrada'] . '">' . $row['dataEntrada'] . '</option>';
                                        }
                                    }
            ...
            <div class="col-md-12">
                ...
                <div class="card" style="width: 100%;">
                    <div class="card-header">
                        ...
                        <button id="btn-relatorioe">Relatório de Entradas</button>
                        <table id="tabela-entrada">


                    </div>
                    <div class="card-body">
                        <table id="tabela-entrada" class="table table-borded table-striped">
                            <thead>
                                <tr>
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                $("#btn-relatorioe").on("click", function() {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            $("#tabela-entrada tbody").empty();
                                            // Adiciona as novas linhas com os dados retornados pelo PHP
                                            $("#tabela-entrada tbody").append(data);
                                        },
                                        error: function() {
