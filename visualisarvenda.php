                        ...
                        ?>
                                ...
                                <form action="operacoesvendas.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="produtoid" value="<?= $consultavendas['produtoid'] ?>" class="form-control">

                                        <label>CODIGO</label>
                                        <input type="text" name="codigoProduto" value="<?= $consultavendas['codigoProduto'] ?>" class="form-control">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime" name="dataAlteracao" value="<?= $consultavendas['dataAlteracao'] ?>" class="form-control">
